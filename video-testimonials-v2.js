(() => {
  ...
  const css = `
    ...
    @media (max-width:650px){
      ...
      .vt-shell{width:100%;height:100dvh;max-height:100dvh;padding:calc(var(--event-header-reserve,72px) + 10px) 8px max(150px,calc(86px + env(safe-area-inset-bottom)));scroll-padding-top:var(--event-header-reserve,72px)}
