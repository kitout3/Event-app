...
function GalleryPage({ setView }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--cream)", paddingBottom: "5rem" }}>
      ...
      {/* Header */}
      <div style={{ background: "var(--white)", borderBottom: "1px solid var(--blush)", padding: "1rem 1.25rem", display: "flex", alignItems: "center", gap: 10, position: "relative", zIndex: 10 }}>
